...
export function getAppLang(c: any): string {
    ...
    if (urlLang) {
        lang = urlLang;
        setCookie(c, 'app_lang', lang, { path: '/', maxAge: 60 * 60 * 24 * 30 });
    }
    return lang;
}
