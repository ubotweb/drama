...
export default createRoute(async (c) => {
  ...
  // ==========================================================
  const media = await fetchEpisodeData(slug, episodeStr);
    ...
    <div class="max-w-3xl mx-auto">
      ...
      <div class="px-4 flex justify-between items-center mb-10">
         ...
         <div class="flex gap-2">
            {episode > 1 && <a href={`/episode/${slug}/${episode - 1}`} class="bg-gray-800 px-4 py-2 rounded-lg text-sm">Prev</a>}
            <a href={`/episode/${slug}/${episode + 1}`} class="bg-red-600 px-4 py-2 rounded-lg text-sm font-bold">Next</a>
         </div>
      </div>
